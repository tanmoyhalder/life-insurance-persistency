...
import pandas as pd
from utils import load_df_for_plots, plot_map, descriptive_polts, fetch_data
...
lapse_rate = (df["lapse"].value_counts() / len(df))[1]
...
with col3:
    ...
    st.metric("Lapse Rate", f"{round(lapse_rate*100, 1)}%")
